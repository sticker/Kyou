...
public abstract class BaseDownloadDaemon extends Service
{
     ...
     * 常駐を開始
     */
    public BaseDownloadDaemon startResident(Context context)
    {
     ...
     * サービスの次回の起動を予約
     */
    public void scheduleNextTime(Calendar cal) {
